  ...
  export const brandingData = [
    {
      ...
      icon: (
        ...
        <rect x="4" y="7" width="16" height="10" rx="2" fill="#ffffff" />
...
>
  ...
  <circle cx="16" cy="14" r="2" fill="#4caf50" />
  
  <path
    d="M8,14 L6,18 M12,14 L12,18 M16,14 L18,18"
    stroke="#4caf50"
    stroke-width="2"
  ...
  />
    ...
    },
    {
      ...
      >
        ...
        <circle cx="9" cy="14" r="1.5" fill="#4caf50" />
        <circle cx="15" cy="14" r="1.5" fill="#4caf50" />
        <path
          d="M12,18c3.31,0,6-2.69,6-6H6C6,15.31,8.69,18,12,18z"
          fill="#4caf50"
        />
      </svg>
...
>
  ...
  <line x1="12" y1="7" x2="12" y2="17" stroke="#4caf50" stroke-width="2" />
  <line x1="7" y1="12" x2="17" y2="12" stroke="#4caf50" stroke-width="2" />
</svg>
